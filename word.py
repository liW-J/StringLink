...
#清理数据！
with open("question/textQuestion2.txt", "r", encoding='utf8') as f1:
    with open("./clear/clear.csv","a",encoding='utf8') as f2:
        for line in f1:
...
with open("./clear/clear.csv","r",encoding='utf8') as f:
    with open("key/key2.csv", "r", encoding='utf8') as f4:
        with open("newKey/newKey2.csv", "r", encoding='utf8') as f5:
            KEY=f5.readlines()
            # Right=f4.readlines()
            keycount=0
            count=0
